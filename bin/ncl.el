...
;********************************************
; Updated: Wed Mar  6 20:47:25 MST 2013
;
; Revision 0.34
...
(defvar ncl-font-lock-keywords
   '(
    ...
    ;; shea_util functions
    ("\\<\\(add90LatX\\|add90LatY\\|boxplot\\|ColorNegDashZeroPosContour\\|ColorShadeLeGeContour\\|drawNDCGrid\\|infoTimeStamp\\|landsea_mask\\|msgValOutline\\|pie_chart\\|plt_pdfxy\\|setColorContourClear\\|ShadeCOI\\|ShadeGeLeContour\\|ShadeGtContour\\|ShadeLtContour\\|ShadeLtGtContour\\|specx_ci\\|\\)\\>" 1 font-lock-function-name-face)

    ;; skewt functions
    ("\\<\\(skewT_BackGround\\|skewT_PlotData\\|\\)\\>" 1 font-lock-function-name-face)

    ;; user_contributed functions
    ("\\<\\(calendar_decode2\\|cd_string\\|kf_filter\\|run_cor\\|time_axis_labels\\|ut_string\\|\\)\\>" 1 font-lock-function-name-face)

    ;; wrf_arw functions
    ("\\<\\(wrf_contour\\|wrf_map\\|wrf_map_overlay\\|wrf_map_overlays\\|wrf_map_resources\\|wrf_map_zoom\\|wrf_overlay\\|wrf_overlays\\|wrf_user_getvar\\|wrf_user_ij_to_ll\\|wrf_user_intrp2d\\|wrf_user_intrp3d\\|wrf_user_latlon_to_ij\\|wrf_user_list_times\\|wrf_user_ll_to_ij\\|wrf_user_unstagger\\|wrf_vector\\|\\)\\>" 1 font-lock-function-name-face)
